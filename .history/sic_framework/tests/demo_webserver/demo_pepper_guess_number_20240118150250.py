...
Rweb_url = 'https://www.wikipedia.org/portal/wikipedia.org/assets/img/Wikipedia-logo-v2@1.5x.png'
...
# dialogflow setup
keyfile_json = json.load(open("gaze-estimation-test-udhr-bc4af1b20449.json"))
